...
/**
 * ZonaOcorrencia generated by hbm2java
 */
public class ZonaOcorrencia  extends IModel<ZonaOcorrencia> implements java.io.Serializable {
    ...
    public ZonaOcorrencia() {
    }

    public ZonaOcorrencia(String codigo, String zonaOcorrencia) {
       this.codigo = codigo;
    ...
    @Override
    public void copyAttributesOf(ZonaOcorrencia copy) {
